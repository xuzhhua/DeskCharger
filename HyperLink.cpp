...
CHyperLink::CHyperLink()
{
    ...
    m_crLinkColour      = 0x00008000;           // RGB(  0,   0, 238);   // Blue
    m_crVisitedColour   = 0x00004080;           // RGB( 85,  26, 139);   // Purple
    m_crHoverColour     = 0x00000080;           // RGB(255,   0,   0);   // Red
...
//2004/01/18，为了显示自定义提示文字，追加
void CHyperLink::SetURL(CString strURL, CString toolTips)
{
    m_strURL = strURL;
    ...
    if (::IsWindow(GetSafeHwnd())) {
		...
		if (toolTips == "")
			...
			m_ToolTip.UpdateTipText(toolTips, this, TOOLTIP_ID);
    }
}
