...
CButtonST::CButtonST()
{
	...
	m_bButtonDisabled   = FALSE;//20040316
...
void CButtonST::DisableButton(int nIconIn, BOOL bEnable /* = TRUE */, int nIconOut /* =  */)//20040316
{
	//0x00E0E0E0
	
	if (bEnable == TRUE)
	{
		//CButtonST::ActivateTooltip(FALSE);
		CButtonST::SetIcon(nIconIn, nIconOut);
		m_bButtonDisabled = TRUE;
	}
	else
	{
		//CButtonST::ActivateTooltip(TRUE);
		CButtonST::SetIcon(nIconIn, nIconOut);
...
LRESULT CButtonST::DefWindowProc(UINT message, WPARAM wParam, LPARAM lParam) //20040316
{
	if (m_bButtonDisabled == TRUE)
	{
